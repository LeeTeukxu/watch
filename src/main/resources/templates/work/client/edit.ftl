...
<@layout>
    ...
    <div style="height: 100%;overflow: hidden;">
        ...
        <form id="clientForm" action="/" method="post" style="display: none">
            <table style="width: 100%; height: 100%" class="layui-table">
                <tr>
                    ...
                    <td>登录邮箱：</td>
                    <td>
                        <input class="mini-textbox" id="email" name="email" style="width: 100%;" vtype="email"/>
                    </td>
                </tr>
                <tr>
                    <td>登记人员：</td>
                    <td>
                        <input class="mini-treeselect" valuefield="FID" parentfield="PID" textfield="Name"
                               url="/system/dep/getAllLoginUsersByDep" id="signMan" name="signMan" style="width: 100%;"
                ...
                <tr>
                    <td>联系方式:</td>
                    <td>
                        <input class="mini-textbox" style="width:100%" name="linkPhone"/>
                    </td>
                    <td>联系人:</td>
                    <td>
                        <input class="mini-textbox" style="width:100%" name="linkMan"/>
                    </td>
                    <td>更多联系方式:</td>
                    <td>
                        <input class="mini-textbox" style="width:100%" name="tele"/>
                    </td>
                </tr>
                <tr>
                    <td>联系地址:</td>
                    <td>
                        <input class="mini-textbox" style="width:100%" name="address"/>
                    </td>
                    <td>信用代码:</td>
                    <td>
        ...
        <div class="mini-fit">
            <div id="tabs1" class="mini-tabs" style="width:100%;height:97%;display: none"
                 bodystyle="padding:0;border:0;border-bottom: 1px solid rgb(210, 210, 210);" activeindex="0">
                <div name="FollowTab" title="跟进记录">
                    <div class="mini-toolbar" id="mainToolbar2" name="followRecordTool"
                    ...
                    <div class="mini-layout" style="width:100%;height:98%">
                        <div region="north" height="240" showHeader="false">
                            ...
                            <div class="mini-fit">
                                <div class="mini-datagrid" id="grid2" style="width:100%;height:100%;"
                                     url="" autoload="false" onrowdblclick="onRowDblClick" ondrawcell="linkerDraw">
                                    <div property="columns">
                                        <div type="indexcolumn"></div>
                                        <div type="checkcolumn"></div>
                        ...
                        <div region="center" title="联系人更新记录">
                            <div class="mini-datagrid" id="grid9" style="width:100%;height:100%;" pagesize="15"
                                 url="/clientInfo/getClientLinkersUpdateRecord?ClientID=${ClientID}"
                                ...
                                <div property="columns">
                                    ...
                                    <div headeralign="center" align="center" field="actionMan"
                                        ...
                                        <input property="editor" class="mini-treeselect"
                                               url="/system/dep/getAllLoginUsersByDep" valueField="FID"
...
<#--                        <a class="mini-button mini-button-primary" onclick="sendZhuanliEmail">发送专利清单</a>-->
                    ...
                    <div class="mini-fit">
                        <div class="mini-datagrid" id="grid3" style="width:100%;height:100%;" autoload="true"
                             multiselect="true" frozenstartcolumn="0" frozenendcolumn="7" pagesize="10"
                             sizelist="[5,10,20,50,100,150,200]" sortfield="LASTUPDATETIME" sortorder="desc">
                            <div property="columns">
                                <div type="indexcolumn"></div>
                                <div type="checkcolumn"></div>
                                <div field="SHENQINGRXM" width="300" headeralign="center">专利申请人</div>
                                <div field="SHENQINGH" width="150" headeralign="center">专利申请号</div>
                                <div field="SHENQINGLX" width="120" headeralign="center" align="center">专利类型</div>
                                <div field="FAMINGMC" width="300" headeralign="center" renderer="onZhanlihaoZhuangtai">
                                    专利名称
                                </div>
                                <div field="LAWSTATUS" width="100" headeralign="center">专利状态</div>
                                <div field="FAMINGRXM" width="200" headeralign="center" align="center">发明人</div>
                                <div field="SHENQINGR" width="80" headeralign="center" datatype="date"
                                     dateformat="yyyy-MM-dd" align="center">
                                    申请日期
                                </div>
                                <div field="LASTUPDATETIME" width="120" headeralign="center" datatype="date"
                                     dateformat="yyyy-MM-dd HH:mm" align="center">
                                    最后更新日期
                                </div>
                            </div>
                        </div>
                ...
                <div name="FeeTab" title="费用监控">
                    <div class="mini-toolbar" id="mainToolbar1"
                         style="text-align:right;padding-right:20px; border: none; background: none;">
                        <a class="mini-button mini-button-success" onclick="order()">生成订单</a>
...
<#--                        <a class="mini-button mini-button-primary" onclick="doSendYear">发送代缴费清单</a>-->
                    ...
                    <div class="mini-fit" id="fitt">
                        <div id="grid4" class="mini-datagrid" style="width: 100%; height: 100%;"
                             frozenstartcolumn="0" frozenendcolumn="5" sortorder="asc" sortfield="SHENQINGH"
                            ...
                            <div property="columns">
                                <div type="indexcolumn"></div>
                                <div type="checkcolumn"></div>
                                <div field="JIAOFEIR" name="JIAOFEIR" width="120" allowsort="true" headeralign="center"
                                     align="center" dataType="date" dateFormat="yyyy-MM-dd">
                                    最后缴费日
                                </div>
                                <div field="FEENAME" name="FEENAME" width="150" allowsort="true" headeralign="center">
                                    费用项目
                                </div>
                                <div field="MONEY" name="MONEY" width="100" allowsort="true"
                                     headeralign="center" align="right" dataType="float">
                                    金额
                                </div>
                                <div field="SHENQINGH" name="shenqingh" width="150" allowsort="true"
                                     headeralign="center" renderer="onZhanlihao">
                                    专利申请号
                                </div>
                                <div field="FAMINGMC" name="FAMINGMC" width="300" allowsort="true" headeralign="center">
                                    专利名称
                                </div>
                                <div field="SHENQINGLX" width="100" headerAlign="center" allowsort="true">
                                    专利类型
                                </div>
                                <div field="SHENQINGR" name="shenqingr" width="120" allowsort="true"
                                     headeralign="center"
                                     datatype="date" dateformat="yyyy-MM-dd">
                                    申请日
                                </div>
                                <div field="LAWSTATUS" width="120" allowsort="true" headeralign="center">
                                    专利法律状态
                                </div>
                ...
                <div name="LoginTab" title="登录记录">
                    <div class="mini-fit">
                        <div class="mini-datagrid" id="grid0" style="width:100%;height:100%;" pagesize="15"
                             ...
                             url="/clientInfo/GetLoginClientReords?ClientID=${ClientID}"
                             autoload="false">
                            <div property="columns">
                                <div type="indexcolumn"></div>
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        <td colspan="8" style="text-align:center">
                            <button class="mini-button" style="width:80px" id="SaveForm1" onclick="SaveRecord">保存
                            </button>
            ...
            <div id="editform2" class="form">
                <table style="width:100%;" class="layui-table">
                    <tr>
                        ...
                        <td>
                            <input class="mini-combobox" id="ctype" name="ctype" style="width: 98%;" required="true"
                                   valuefield="text" url="/system/dict/getByDtId?dtId=14"/>
                            <input class="mini-hidden" id="linkID" name="linkID"/>
                        </td>
                        <td>联系人姓名：</td>
                        <td>
                            <input class="mini-textbox" id="linkMan" name="linkMan" style=" width: 98%;"
                                   required="true"/>
                        </td>
                        <td>手机号码：</td>
                        <td>
                    ...
                    <tr>
                        <td>座机号码：</td>
                        <td>
                            <input class="mini-textbox" id="linkPhone" name="linkPhone" style="width: 98%;"
                                   required="true"/>
                        </td>
                        <td>传真号码：</td>
                        <td>
                    ...
                    <tr>
                        <td>备注</td>
                        <td colspan="6">
                            <textarea class="mini-textarea" style="width:100%;height:60px" name="memo"
                                      id="Memo"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="6" style="text-align:center">
                            <button class="mini-button mini-button-primary" style="width:120px" id="SaveForm2"
                                    onclick="SaveLink">确定
                            </button>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <script type="text/javascript">
            ...
            tabs.on("activechanged", function (e) {
                ...
                if (e.tab.title == "跟进记录") {
                    ...
                    if (grid2.getUrl() == '' && clientId) {
                        grid2.setUrl('/clientInfo/getFollowRecords');
                ...
                if (e.tab.title == "联系人信息") {
                    var grid2 = mini.get('grid2');
                    if (grid2.getUrl() == '' && clientId) {
                        grid2.setUrl('/clientInfo/getClientLinkers');
                        grid2.load({ClientID: clientId});
                ...
                if (e.tab.title == "专利清单") {
                    ...
                    if (clientId) {
                        grid3.setUrl('/patent/getData');
                        var kc = [{"field": "ClientID", "value": clientId, "oper": "EQ"}];
                        grid3.load({
                ...
                if (e.tab.title == "费用监控") {
                    ...
                    if (grid4.getUrl() == '' && clientId) {
                        grid4.setUrl('/work/govFee/getData');
                        var op = {field: 'CLIENTID', oper: 'EQ', value: clientId};
                        grid4.load({
                            'High': mini.encode([op]),
                            'State': 'All'
                        });
        ...
        function getReClientName(Data) {
            ...
            var url = '/clientInfo/findNameByName';
            $.post(url, arg,
                function (text) {
        ...
        if (mode == "Edit") {
            ...
            var form = new mini.Form('#clientForm');
            if (formData.signDate != undefined) {
                formData.signDate = new Date(formData.signDate);
            }
            if (formData.createTime != undefined) {
                formData.createTime = new Date(formData.createTime);
            }
            form.setData(formData);
            var grid1 = mini.get('grid1');
            if (grid1.getUrl() == '') {
                grid1.setUrl('/clientInfo/getFollowRecords');
        ...
        function SaveLink() {
            ...
            if (form.isValid()) {
                ...
                if (!clientId) {
                    ...
                    form.loading("保存中........");
                    var url = "/clientInfo/saveClientLinkers";
        ...
        function doSendYear() {
            function p() {
                ...
                if (postResult) {
                    ...
                    var url = "/clientInfo/downLoadDJFQD";
                    $.post(url, arg,
                        function (text) {
                            var res = mini.decode(text);
                            if (res.success) {
        ...
        function sendZhuanliEmail() {
            ...
            var GridExcelURL = "/clientInfo/getGridDataExcel";
            var ExcelPath = "";
            $.post(GridExcelURL, {
                data: mini.encode(data),
        ...
        function saveImage() {
            ...
            var url = '/clientInfo/saveImageFollow';
        ...
        function order() {
            ...
            var jiaofeirs = [];
            for (var i = 0; i < rows.length; i++) {
                if (rows[i]["Generate"] == 0){
                    mini.alert("您选择的官费信息存在已生成订单，请勿重复生成订单！");
                    return;
                }
