                                    ...
                                    <div class="info1top" style="padding-left: 120px;">
                                        ...
                                        <ul>
                                            <li class="Jdlcli YearSource" id="J1" >
                                                <a style="text-decoration:none" target="_self" href="#" onclick="changeQuery('Index',0,this)">
                    ...
                    <tr>
                        ...
                        <td style="white-space:nowrap;">
                            <div class="mini-combobox Query_Field FeeItemYear_Query" id="comField" style="width:100px"
                                 data="[{id:'All',text:'全部属性'},{id:'ShenQingh',text:'专利号'},{id:'FeeName',text:'缴费清单'},
                                 {id:'FAMINGMC',text:'发明名称'},{id:'SHENQINGRXM',text:'申请人姓名'},{id:'KH',text:'所属客户'},{id:'XS',text:'销售人员'},{id:'DL',text:'代理师'},{id:'LC',text:'流程人员'}]" value="All"
                                 id="Field"></div>
                ...
                <div id="p1" style="border:1px solid #909aa6;border-top:0;height:150px;padding:5px;display:none">
                    <table style="width:100%;" id="highQueryForm">
                        ...
                        <tr>
                            ...
                            <td style="width:15%;"><input name="LAWSTATUS" class="mini-textbox" data-oper="LIKE" style="width:100%"/></td>
            ...
            <div class="mini-fit" id="fitt">
                <div id="FeeItemYear_datagrid" class="mini-datagrid" style="width: 100%; height: 100%;" onrowclick="onRowClick"
                    ...
                    <div property="columns">
                        ...
                        <div field="LAWSTATUS" width="210" allowsort="true" headeralign="center">
                            专利法律状态
                        </div>
