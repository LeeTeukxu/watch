            ...
            <div title="选择专利挖掘文件">
                    ...
                    <table style="width:100%;">
                        <tr>
                            <td style="width:100%;">
                                ...
                                <a class="mini-button" iconCls="icon-zoomin" onclick="doQuery()">可选文件</a>
                                <a class="mini-button" iconCls="icon-zoomout" onclick="querySelect()">已选文件</a>
                            </td>
                            <td style="white-space:nowrap;">
                                <a class="mini-button" id="checkTech" iconcls="icon-save"  onclick="saveTechSupport()"
                ...
                <div class="mini-fit">
                    <div class="mini-datagrid" id="datagrid1" style="width:100%;height:100%" sortfield="UploadTime"
                         onbeforeselect="beforeSelectTech"
                         sortorder="desc" pagesize="20"  url="/techSupport/getFiles?State=10&Mode=Select"
                         autoload="false">
                        <div property="columns">
                            <div type="checkcolumn"></div>
...
<#--                            </div>-->
                            ...
                            <div field="Name" width="150"  align="center"  headeralign="center"  allowSort="true">文件名称</div>
...
<div class="mini-window" title="专利申报文件提交核稿" width="600" height="240" style="display:none" id="CommitWindow">
    <table style="width:100%" class="layui-table" id="CommitForm">
        ...
        <tr>
            <td>指定核稿人</td>
            <td>
                <div id="ConAuditMan" class="mini-treeselect" style="width:100%"  url="/system/dep/getAllLoginUsersByDep"
...
<@js>
    <script type="text/javascript">
        ...
        function saveTechSupport(){
            ...
            if(row){
                var attId=row["AttID"];
                eventFun.eachFileUploaded({AttID:attId});
        ...
        function querySelect(){
            ...
            grid1.setUrl('/techSupport/getFiles?RefID=${SubID}');
            grid1.load(arg);
        }
        function doQuery(){
            var txtQuery=mini.get('QueryText');
            ...
            grid1.setUrl('/techSupport/getFiles?State=10&Mode=Select');
            grid1.load(arg);
        }
