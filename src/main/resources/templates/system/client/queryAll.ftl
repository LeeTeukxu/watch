...
<@layout>
                ...
                <div title="客户列表" bodyStyle="overflow:hidden">
                    ...
                    <div class="mini-fit">
                        <div id="grid1" class="mini-datagrid" style="width:100%;height:100%;"
                             idfield="id" allowresize="true" url="/clientInfo/getAll?KHID=${KHID}" sortorder="asc"
                ...
                <div title="人员列表" bodyStyle="overflow:hidden">
                    ...
                    <div class="mini-fit">
                        <div id="grid2" class="mini-datagrid" style="width:100%;height:98%;"
                             idfield="id" allowresize="true" url="/clientInfo/getAllEmailUser" sortorder="asc"
                             sortfield="UserName" autoload="true" multiSelect="true" onselect="onSelect"
    ...
    <script type="text/javascript">
        ...
        function clear(){
           grid1.setUrl('/clientInfo/getAll');
           grid1.reload();
        }
        function search1() {
