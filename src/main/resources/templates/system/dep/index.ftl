    ...
    <div class="mini-layout" style="width: 100%; height: 100%;overflow:hidden">
        <div region="west" title="公司列表" width="260">
            <ul class="mini-tree" idField="FID" parentField="PID" textField="Name" resultAsTree="false"
                url="/loginUser/getCompanyList" expandOnload="true" id="LeftTree" onnodeclick="nodeClick" id="tree1"></ul>
        </div>
        <div region="center" style="overflow:hidden">
            ...
            <div class="mini-fit">
                <div id="tbDepList_treegrid" class="mini-treegrid" style="width:100%;height:100%"
                     treeColumn="depId" idField="depId" parentField="pid" resultAsTree="false" editNextOnEnterKey="true"
                    ...
                    <div property="columns">
                        ...
                        <div id="depId" name="depId" field="depId" width="100" headeralign="center" vtype="required">办公室编号
                            <input property="editor" class="mini-textbox" style=" width:100%"/>
                        </div>
                        <div name="name" field="name" width="200" headeralign="center" vtype="required">办公室名称
