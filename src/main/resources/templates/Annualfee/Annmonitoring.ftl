...
<div class="row">
    <div class="col-md-12" style="height: 32px">
        <div id="north" class="mini-layout-region mini-layout-region-north" style="width: 100%; left: 0px; top: 0px; height: 31px;">
            <div class="mini-layout-region-header" style="display: none;"><div class="mini-tools"><span class="mini-icon mini-tools-collapse" style="undefined;">
     </span><span class="mini-icon mini-tools-close" style="undefined;display:none;"></span></div><div class="mini-layout-region-icon mini-icon " style=";display:none;"></div>
                <div class="mini-layout-region-title"></div></div><div class="mini-layout-region-body " style="padding-top: 5px; height: 26px;">
        <span>
...
<div class="col-md-12">
    <div class="mini-toolbar">
        <table style="width:100%">
            <tbody><tr>
                <td style="width:95%">
                    <a class="mini-button mini-state-default mini-corner-all mini-button-success" href="javascript:void(0)" id="PatentInfoBrowse_doJiaJi" style=""><span class="mini-button-inner "><span class="mini-button-text">标记不缴费</span></span></a>
                    <a class="mini-button mini-state-default mini-corner-all mini-button-danger" href="javascript:void(0)" id="PatentInfoBrowse_unJiaJi" style=""><span class="mini-button-inner "><span class="mini-button-text">标记需缴费</span></span></a>
                    <a class="mini-button mini-state-default mini-corner-all mini-button-success" href="javascript:void(0)" id="PatentInfoBrowse_doJieAn" style=""><span class="mini-button-inner "><span class="mini-button-text">添加到缴费清单</span></span></a>
                    <span class="separator"></span>
                    <a class="mini-button mini-state-default mini-corner-all mini-button-info" href="javascript:void(0)" id="PatentInfoBrowse_Download" style=""><span class="mini-button-inner "><span class="mini-button-text">导出Excel</span></span></a>
                    <a class="mini-button mini-state-default mini-corner-all mini-button-info" href="javascript:void(0)" id="PatentInfoBrowse_ChangeJS" style=""><span class="mini-button-inner "><span class="mini-button-text">导出待缴费清单</span></span></a>
                    <a class="mini-button mini-state-default mini-corner-all mini-button-info" href="javascript:void(0)" id="PatentInfoBrowse_Export" style=""><span class="mini-button-inner "><span class="mini-button-text">校对金额</span></span></a>
                    <a class="mini-button mini-state-default mini-corner-all mini-button-info" href="javascript:void(0)" id="PatentInfoBrowse_Import" style=""><span class="mini-button-inner "><span class="mini-button-text">手续费</span></span></a>
                </td>
...
<div class="col-md-12">
    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:700px;"
        ...
        <div property="columns">
            ...
            <div field="SHENQINGH" width="50" headerAlign="center" align="center" allowSort="true">监控状态</div>
            <div field="SHENQINGH" width="50" headerAlign="center" align="center" allowSort="true">备注信息</div>
            <div field="FAMINGMC" width="50" headerAlign="center" align="center" allowSort="true">缴纳截止日</div>
            <div field="SHENQINGR" width="50" dataType="date" dateFormat="yyyy-MM-dd" headerAlign="center" align="center">费用项目</div>
            <div field="CostName" width="50" headerAlign="center" align="center" allowSort="true">金额</div>
            <div field="Amount" width="50" headerAlign="center" align="center" allowSort="true">人工校对金额</div>
            <div field="LimitDate" width="50" dataType="date" dateFormat="yyyy-MM-dd" headerAlign="center" align="center">手续费</div>
            <div field="famingr" width="50" dataType="date" dateFormat="yyyy-MM-dd" headerAlign="center" align="center">是否需缴费</div>
            <div field="CostName" width="50" headerAlign="center" align="center" allowSort="true">专利申请人</div>
            <div field="Amount" width="50" headerAlign="center" align="center" allowSort="true">专利申请号</div>
            <div field="CostName" width="50" headerAlign="center" align="center" allowSort="true">申请日</div>
            ...
            <div field="Amount" width="50" headerAlign="center" align="center" allowSort="true">专利法律状态</div>
            <div field="CostName" width="50" headerAlign="center" align="center" allowSort="true">专利发明人</div>
            <div field="Amount" width="50" headerAlign="center" align="center" allowSort="true">归属客户</div>
        </div>
    </div>
</div>
</div>
