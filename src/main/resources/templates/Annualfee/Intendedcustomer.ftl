...
<div class="col-md-12">
    <div class="mini-toolbar">
        <table style="width:100%">
            <tbody><tr>
                <td style="width:95%">
                    <a class="mini-button mini-state-default mini-corner-all mini-button-success" href="javascript:void(0)" onclick="Addcustomers()" id="PatentInfoBrowse_doJiaJi" style=""><span class="mini-button-inner "><span class="mini-button-text">新增</span></span></a>
                    <a class="mini-button mini-state-default mini-corner-all mini-button-danger"  href="javascript:void(0)" id="PatentInfoBrowse_unJiaJi" style=""><span class="mini-button-inner "><span class="mini-button-text">修改</span></span></a>
                    <a class="mini-button mini-state-default mini-corner-all mini-button-success" href="javascript:void(0)" id="PatentInfoBrowse_doJieAn" style=""><span class="mini-button-inner "><span class="mini-button-text">删除</span></span></a>
                    <a class="mini-button mini-state-default mini-corner-all mini-button-danger"  href="javascript:void(0)" id="PatentInfoBrowse_unJieAn" style=""><span class="mini-button-inner "><span class="mini-button-text">浏览</span></span></a>
                    <span class="separator"></span>
                    <a class="mini-button mini-state-default mini-corner-all mini-button-success" href="javascript:void(0)" id="PatentInfoBrowse_configNBBH" style=""><span class="mini-button-inner "><span class="mini-button-text">导入客户</span></span></a>
                    <a class="mini-button mini-state-default mini-corner-all mini-button-danger" href="javascript:void(0)" id="PatentInfoBrowse_unNBBH" style=""><span class="mini-button-inner "><span class="mini-button-text">导出Excel</span></span></a>
                    <span class="separator"></span>
                    <a class="mini-button mini-state-default mini-corner-all mini-button-info" href="javascript:void(0)" id="PatentInfoBrowse_Download" style=""><span class="mini-button-inner "><span class="mini-button-text">转移客户</span></span></a>
                    <a class="mini-button mini-state-default mini-corner-all mini-button-info" href="javascript:void(0)" id="PatentInfoBrowse_ChangeJS" style=""><span class="mini-button-inner "><span class="mini-button-text">发密码给客户</span></span></a>
                </td>
...
<div class="col-md-12">
    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:700px;"
        ...
        <div property="columns">
            ...
            <div field="SHENQINGH" width="50" headerAlign="center" align="center" allowSort="true">合作类型</div>
            <div field="FAMINGMC" width="50" headerAlign="center" align="center" allowSort="true">客户名称</div>
            <div field="SHENQINGR" width="50" dataType="date" dateFormat="yyyy-MM-dd" headerAlign="center" align="center">代理费对账</div>
            <div field="CostName" width="50" headerAlign="center" align="center" allowSort="true">官费对账</div>
            <div field="Amount" width="50" headerAlign="center" align="center" allowSort="true">企业性质</div>
            <div field="LimitDate" width="50" dataType="date" dateFormat="yyyy-MM-dd" headerAlign="center" align="center">介绍人</div>
            <div field="famingr" width="50" dataType="date" dateFormat="yyyy-MM-dd" headerAlign="center" align="center">登录邮箱</div>
            <div field="CostName" width="50" headerAlign="center" align="center" allowSort="true">上次发送密码时间</div>
            <div field="Amount" width="50" headerAlign="center" align="center" allowSort="true">登记人</div>
            <div field="CostName" width="50" headerAlign="center" align="center" allowSort="true">登记日期</div>
            <div field="Amount" width="50" headerAlign="center" align="center" allowSort="true">最新跟进时间</div>
            <div field="Amount" width="50" headerAlign="center" align="center" allowSort="true">备注</div>
        </div>
    </div>
</div>
</div>
