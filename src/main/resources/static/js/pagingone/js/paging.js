(function ($, window, document, undefined) {
    var Paging = function (elem, options) {
        ...
        this.numbers=this.opts.numbers;
    ...
    Paging.prototype = {
        ...
        pageChanged:function(){
            ...
            this.setPaging(this.iNum);
            this.detectionPage(this.iNum);
            this.opts.pageChanged && this.opts.pageChanged(this.iNum);
        },
        ...
        initalPaging: function () {
            ...
            if (this.allPages <= this.displayPage) {
                ...
                this.$oGo_text.attr('placeholder',this.numbers+'条记录,'+this.allPages+'页').css({'font-size':'12px'});
            } else {
