(function ($) {
    $.fn.fileUploader = function (options) {
        ...
        function createGrid() {
            var op = [
                '<div class="mini-fit">',
                '<div id="CompanyList" class="mini-datagrid" style="width: 100%; height:99%" autoload="true"' +
                ' sortfield="id" sortorder="asc" pagesize="20">',
                '<div property="columns">',
                '<div field="id"  width="80" headeralign="center" allowsort="true">序号</div>',
                '<div field="name" width="300" headeralign="center" allowsort="true">企业名称</div>',
                '<div field="code"  width="200" headeralign="center"allowsort="true">证书编号</div>',
                '</div>',
                '</div>',
                '</div>',
            ];
                ...
                init: {
                    ...
                    FileUploaded: function (up, file, res) {
                        ...
                        if (result.success) {
                            ...
                            var url = '/companyall/getTechResult?collectionName=' + collectionName;
                            fileGrid.setUrl(url);
        ...
        function SaveToSqlServer() {
            ...
            $.post("/companyall/importAll1", {collectionName: collectionName}, function (result) {
