$(function(){
    ...
    $('.lsm-mini-btn svg').on('click',function(){
        ...
        if ($('.lsm-mini-btn input[type="checkbox"]').prop("checked")) {
            ...
            document.getElementById('westleft').style.width="30px"
            document.getElementById('bodycenter').style.marginLeft="60px";
            mini.get("zwr").setBodyStyle("width:117%");

        }else{
            $('.left-side-menu').removeClass('lsm-mini');
            $('.lsm-container ul ul').css("display", "none");
            $('.left-side-menu').stop().animate({width: 250},200);
            document.getElementById('westleft').style.width="13%"
            document.getElementById('bodycenter').style.marginLeft="250px";
            mini.get("zwr").setBodyStyle("width:102%");
