...
public class CompanyTokenUtils {
    ...
    public static void deleteByToken(String webToke) {
        ...
        if (Strings.isEmpty(tokenName) == false) {
    ...
    public static String getOrCreateToken(String account) {
        String webKey = "webToken::" + account;
    ...
    public static boolean existTokenByAccount(String account) {
        String webKey = "webToken::" + account;
        Object tokenObj = redisTemplate.opsForValue().get(webKey);
