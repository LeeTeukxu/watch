...
import com.zhide.govwatch.define.ITicketService;
import com.zhide.govwatch.mapper.PantentInfoMemoMapper;
import com.zhide.govwatch.mapper.TicketsMapper;
import com.zhide.govwatch.mapper.patentMemoMapper;
...
import com.zhide.govwatch.repository.ticketsRepository;
    ...
    public tbAttachment AddTickFile(MultipartFile file) throws Exception {
        ...
        if (fx.exists()) {
            ...
            for (int i = 0; i < IDS.size(); i++) {
                ...
                ticket.setCreateMan(Info.getUserId());
                ticket.setSource(OO.getGuid());
                Optional<patent> findPs = pRep.findByShenqingh(ticket.getShenqingh());
